...
namespace OpenKikai.App.Services;
...
public sealed unsafe partial class OpenXrControllerInputService
{
    ...
    private static ApplicationInfo CreateApplicationInfo()
    {
        ...
        WriteFixedUtf8(applicationName, (int)XR.MaxApplicationNameSize, "OpenKikai.App");
        var engineName = applicationInfo.EngineName;
        WriteFixedUtf8(engineName, (int)XR.MaxEngineNameSize, "OpenKikai.OpenXR");
