...
DefaultDirName={autopf}\OpenKikai
DefaultGroupName=OpenKikai
DisableProgramGroupPage=yes
OutputBaseFilename=OpenKikai-Installer
OutputDir=Output
Compression=lzma
SolidCompression=yes
SetupIconFile=icon\icon.ico
UninstallDisplayIcon={app}\OpenKikai.App.exe

[Files]
Source: "..\OpenKikai.App\bin\Release\net10.0-windows\win-x64\publish\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs

[Icons]
Name: "{autoprograms}\OpenKikai"; Filename: "{app}\OpenKikai.App.exe"
Name: "{autodesktop}\OpenKikai"; Filename: "{app}\OpenKikai.App.exe"; Tasks: desktopicon

[Tasks]
Name: "desktopicon"; Description: "Create a &desktop icon"; GroupDescription: "Additional icons"; Flags: unchecked

[Run]
Filename: "{app}\OpenKikai.App.exe"; Description: "Launch OpenKikai"; Flags: nowait postinstall skipifsilent
...
begin
  ...
  begin
    MsgBox(
      '.NET Desktop Runtime 10 is required to run OpenKikai.'#13#10 +
